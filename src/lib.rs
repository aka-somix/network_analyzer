...
pub mod sniffer {
    ...
    pub struct Sniffer {
        ...
        file: Option<String>,
        time_interval: u64,
        hashmap: Arc<Mutex<HashMap<(String, u16), (Protocol, usize, Direction)>>>, //si potrebbe mettere la tupla con codvar come per lo status
    }
    ...
    impl Sniffer {
                            ...
                            match &status {
                                Status::Running => {
                                    ...
                                    match cap.next_packet() {
                                        Ok(packet)  => {
                                            match extract_info_from_packet(device, packet) {
                                                Ok(info) => {
        ...
        //TODO REFACTOR
        fn center(hashmap: Arc<Mutex<HashMap<(String, u16), (Protocol, usize, Direction)>>>) -> String {
                ...
                _ => {
                    if self.get_file().is_none() {
                        ...
                        if self.get_time_interval() == 0 {
                            ...
                            }; //TODO LA DIFFERENZA RISPETTO AL CASO IN CUI ENTRA NELL'IF E' CHE NON DEVE METTERE LA TESTINA ALL'INIZIO E METTERE HEADER ETC..A
                            center = Sniffer::center(self.get_hashmap().clone());
